function astrctMesh= fnCreateRectChamberMesh3D(fWidthMM, fLengthMM, fHeightMM,fDepthMM,afColor)
...
astrctMesh(2) = fnCreateRectChamberMeshAux3D(fWidthMM, fLengthMM, -fHeightMM, 0, afColor);



if fDepthMM > 0
    %astrctMesh(3) = fnCreateRectChamberMeshAux(fWidthMM, -fHeightMM, -fHeightMM-fDepthMM, afColor*0.5);
    astrctMesh(3) = fnCreateRectChamberMeshAux3D(fWidthMM, fLengthMM, -fHeightMM, -fHeightMM-fDepthMM, afColor*0.5);
end
% 
% a2fT = eye(4);
...
function strctMesh = fnCreateRectChamberMeshAux3D(fWidthMM, fLengthMM, fLowZ, fHighZ, afColor)
