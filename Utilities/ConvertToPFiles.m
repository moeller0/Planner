%sm: since planner is open source now we do neither need nor want pcode,
%and since this code overwrites PlannerConfig.xml and eletes a lot of stuff
%just guard it with really_convert_to_pfiles
really_convert_to_pfiles = 0;

if (really_convert_to_pfiles)
	%%
